...
<div id="section_470_left">
	<a href="?p=upload_shared_document" class="k-button">Upload Document</a>
	<p id="important_small">Anyone can view/delete files that are uploaded here.</p>
</div>
<div id="clear"></div>
    ...
    $(document).ready(function() {
        $("#grid").kendoGrid({
            dataSource: {
    			transport: {
        			read: {
            		url: "mods/documents/data/get_shared_documents.php",
            		dataType: "json"
        		}
    		},
                schema: {
                ...
                selectable:true,
                    ...
                    field:"document_upload_date",
                        ...
                        title:"Options",
                        filterable: false,
                        template:"<a href='?p=shared_documents&o=download&id=#=document_volunteer_id#&doc_id=#=document_id#' class='k-button'>Download</a> <a href='?p=shared_documents&o=delete&id=#=document_volunteer_id#&doc_id=#=document_id#' class='k-button'>Delete</a>"
                    },
                    ]
                });
        });
