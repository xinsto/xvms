...
<div id="section_470_left">
	<a href="?p=upload_personal_document" class="k-button">Upload Document</a>
	<p id="important_small">Only you can view douments uploaded here.</p>
</div>
<div id="clear"></div>
    ...
    $(document).ready(function() {
        $("#grid").kendoGrid({
            dataSource: {
    			transport: {
        			read: {
            		url: "mods/documents/data/get_personal_documents.php?id=<?php echo $_SESSION['volunteer_id']; ?>",
            		dataType: "json"
        		}
    		},
                schema: {
                ...
                selectable:true,
                    ...
                    field:"document_upload_date",
                        ...
                        title:"Options",
                        filterable: false,
                        template:"<a href='?p=personal_documents&o=download&id=#=document_volunteer_id#&doc_id=#=document_id#' class='k-button'>Download</a> <a href='?p=personal_documents&o=delete&id=#=document_volunteer_id#&doc_id=#=document_id#' class='k-button'>Delete</a>"
                    },
                    ]
                });
        });
